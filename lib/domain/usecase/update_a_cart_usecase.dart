...
@Injectable()
final class UpdateACartUsecase
    extends UseCaseAsync<ListOfCartItemEntity, UpdateACartParams> {
  final ICartRepository _cartRepository;

  UpdateACartUsecase(this._cartRepository);

  @override
  ResultFuture<ListOfCartItemEntity> call(UpdateACartParams params) {
